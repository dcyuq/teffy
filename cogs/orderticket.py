...
def setup_status(guild_id):
    ...
    return discord.Embed(
        ...
        description=(
            ...
            "The selected ticket button uses the normal ticket question form "
            "with the confirmation questions inserted into it."
        ),
    )
