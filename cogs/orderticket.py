    ...
    def __init__(self, parent):
        ...
        options = [
            discord.SelectOption(
                ...
                description="Use the confirmation form for this button",
                default=(
                    button_data["key"]
